...
* [`src/app/styles.cljs`](src/app/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/app/`](src/app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/app/core.cljs): contains the SPA entry point, `init`
* [`test/app/`](test/app/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `app` project root directory
