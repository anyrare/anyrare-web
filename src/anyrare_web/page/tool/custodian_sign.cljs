          ...
          [:div {:class [:py-4]}
           ...
           [:div
            ...
            [:div {:class [:flex :mt-2]}
             [:div {:class ["w-1/2"]}
              ...
              [avatar-with-username
               (get-in asset [:founder :thumbnail])
               (get-in asset [:founder :username])
               (get-in asset [:founder :address])]]
             [:div {:class ["w-1/2"]}
            ...
            [:button {:class [:button :bg-primary :rounded-full
                      ...
                      :on-click #(dispatch [::events/custodian-sign
